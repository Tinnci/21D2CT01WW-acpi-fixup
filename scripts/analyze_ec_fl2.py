...
def find_vector_tables(data):
    ...
    for c in candidates[:10]:
        ...
        for v in range(4, min(16, len(vecs))):
            vec = vecs[v]
            names = {4:'MemManage', 5:'BusFault', 6:'UsageFault', 7:'Rsvd7',
                     8:'Rsvd8', 9:'Rsvd9', 10:'Rsvd10', 11:'SVCall',
                     12:'DebugMon', 13:'Rsvd13', 14:'PendSV', 15:'SysTick'}
...
def find_strings(data):
    ...
    keywords = ['USB', 'usb', 'MUX', 'mux', 'UCSI', 'ucsi', 'PD', 'Type-C', 'typec',
                'TCPC', 'tcpc', 'retimer', 'GPIO', 'gpio', 'SMB', 'smb', 'I2C', 'i2c',
                'port', 'PORT', 'hub', 'HUB', 'alt', 'ALT', 'mode', 'MODE',
                'NPCX', 'Nuvoton', 'Lenovo', 'lenovo', 'LENOVO',
                'EC', 'KBC', 'kbc', 'ACPI', 'acpi', 'SCI', 'SMI',
                'battery', 'power', 'charge', 'thermal', 'fan',
                'N3G', 'version', 'Version']
