...
:MT
BIOSID.efi /SC "81YT" %2
if %lasterror% == 0 then
   uRWEEPROM.EFI /w 0 F6 F6 00
   cls
   echo Done..
endif

BIOSID.efi /SC "81YV" %2
if %lasterror% == 0 then
   uRWEEPROM.EFI /w 0 F6 F6 00
   cls
   echo Done..
...
BIOSID.efi /SC "81YU" %2
if %lasterror% == 0 then
   uRWEEPROM.EFI /w 0 F6 F6 01
   cls
   echo Done..
endif

BIOSID.efi /SC "81YW" %2
if %lasterror% == 0 then
   uRWEEPROM.EFI /w 0 F6 F6 01
   cls
   echo Done..
...
BIOSID.efi /SC "82EH" %2
if %lasterror% == 0 then
   uRWEEPROM.EFI /w 0 F6 F6 02
   cls
   echo Done..
endif
...
uRWEEPROM.EFI /w 0 50 50 [%2]
endif

if %Length% == 2 then
uRWEEPROM.EFI /w 0 52 52 00
uRWEEPROM.EFI /w 0 50 51 [%2]
endif

if %Length% == 3 then
uRWEEPROM.EFI /w 0 53 53 00
uRWEEPROM.EFI /w 0 50 52 [%2]
endif

if %Length% == 4 then
uRWEEPROM.EFI /w 0 54 54 00
uRWEEPROM.EFI /w 0 50 53 [%2]
endif

if %Length% == 5 then
uRWEEPROM.EFI /w 0 55 55 00
uRWEEPROM.EFI /w 0 50 54 [%2]
endif

if %Length% == 6 then
uRWEEPROM.EFI /w 0 56 56 00
uRWEEPROM.EFI /w 0 50 55 [%2]
endif

if %Length% == 7 then
uRWEEPROM.EFI /w 0 57 57 00
uRWEEPROM.EFI /w 0 50 56 [%2]
endif

if %Length% == 8 then
uRWEEPROM.EFI /w 0 58 58 00
uRWEEPROM.EFI /w 0 50 57 [%2]
endif

if %Length% == 9 then
uRWEEPROM.EFI /w 0 59 59 00
uRWEEPROM.EFI /w 0 50 58 [%2]
endif

if %Length% == 10 then
uRWEEPROM.EFI /w 0 5A 5A 00
uRWEEPROM.EFI /w 0 50 59 [%2]
endif

if %Length% == 11 then
uRWEEPROM.EFI /w 0 5B 5B 00
uRWEEPROM.EFI /w 0 50 5A [%2]
endif

if %Length% == 12 then
uRWEEPROM.EFI /w 0 5C 5C 00
uRWEEPROM.EFI /w 0 50 5B [%2]
endif

if %Length% == 13 then
uRWEEPROM.EFI /w 0 5D 5D 00
uRWEEPROM.EFI /w 0 50 5C [%2]
endif

if %Length% == 14 then
uRWEEPROM.EFI /w 0 5E 5E 00
uRWEEPROM.EFI /w 0 50 5D [%2]
endif

if %Length% == 15 then
uRWEEPROM.EFI /w 0 5F 5F 00
uRWEEPROM.EFI /w 0 50 5E [%2]
endif

if %Length% == 16 then
uRWEEPROM.EFI /w 0 60 60 00
uRWEEPROM.EFI /w 0 50 5F [%2]
endif

if %Length% == 17 then
uRWEEPROM.EFI /w 0 61 61 00
uRWEEPROM.EFI /w 0 50 60 [%2]
endif

if %Length% == 18 then
uRWEEPROM.EFI /w 0 62 62 00
uRWEEPROM.EFI /w 0 50 61 [%2]
endif

if %Length% == 19 then
uRWEEPROM.EFI /w 0 63 63 00
uRWEEPROM.EFI /w 0 50 62 [%2]
endif

if %Length% == 20 then
uRWEEPROM.EFI /w 0 64 64 00
uRWEEPROM.EFI /w 0 50 63 [%2]
endif

if %Length% == 21 then
uRWEEPROM.EFI /w 0 65 65 00
uRWEEPROM.EFI /w 0 50 64 [%2]
endif

if %Length% == 22 then
uRWEEPROM.EFI /w 0 66 66 00
uRWEEPROM.EFI /w 0 50 65 [%2]
endif

if %Length% == 23 then
uRWEEPROM.EFI /w 0 67 67 00
uRWEEPROM.EFI /w 0 50 66 [%2]
endif

if %Length% == 24 then
uRWEEPROM.EFI /w 0 68 68 00
uRWEEPROM.EFI /w 0 50 67 [%2]
endif

if %Length% == 25 then
uRWEEPROM.EFI /w 0 69 69 00
uRWEEPROM.EFI /w 0 50 68 [%2]
endif

if %Length% == 26 then
uRWEEPROM.EFI /w 0 6A 6A 00
uRWEEPROM.EFI /w 0 50 69 [%2]
endif

if %Length% == 27 then
uRWEEPROM.EFI /w 0 6B 6B 00
uRWEEPROM.EFI /w 0 50 6A [%2]
endif

if %Length% == 28 then
uRWEEPROM.EFI /w 0 6C 6C 00
uRWEEPROM.EFI /w 0 50 6B [%2]
endif

if %Length% == 29 then
uRWEEPROM.EFI /w 0 6D 6D 00
uRWEEPROM.EFI /w 0 50 6C [%2]
endif

if %Length% == 30 then
uRWEEPROM.EFI /w 0 6E 6E 00
uRWEEPROM.EFI /w 0 50 6D [%2]
endif

if %Length% == 31 then
uRWEEPROM.EFI /w 0 6F 6F 00
uRWEEPROM.EFI /w 0 50 6E [%2]
endif
